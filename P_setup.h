...
<html>
    <head>
        ...
        <title>Informer_clock_weath на ESP8266 ver:01.2020.1x (By IvanUA)</title>
    ...
    <body onload = "load_setup();">
        ...
        <central-unit>
            ...
            <div class="informer">
                <span class="opt_cn">Здесь можно настроить параметры экрана</a>
            </div> 
            <div id="main_unit">
                <center>
                    ...
                    <div class="informer">
                        <span class="opt_cn">Подтягивающий резистор </span>
                    </div>
                    <table id="table__font" class = "table">
                        <tr>
                            <td></td>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Vla</span></td>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Dav</span></td>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">DDDDD</span></td>
                            <td><select id = "pressSys">
                              <option value = "0"> hPa0 </option>
                              <option value = "1"> mmHg1 </option>
                            </select></td>
                            <td></td>
                            <td><span class="opt_cn"> {{Pu}} </span></td>
                        </tr>
